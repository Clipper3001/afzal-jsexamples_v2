...
async function fetchColorsList() {
    ...
    try {
        ...
        // fetching subsequent data (using a For Loop)
        let allColors = resp.data;                                              /* fetch 6 items */
        ...
        console.log(allColors);                             /*  returns 12 colors */
        ...
        // Store the array data arrColors into the browser window's localStorage. store as value in web local storage
...
function loadColorsFromStorage() {
    ...
    const parsedColors = JSON.parse(arrColors);                     /* parse stringify from web local storage  back to .json */
